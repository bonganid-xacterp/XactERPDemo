...
FUNCTION db_drop_tables()
    ...
    EXECUTE IMMEDIATE "DROP TABLE wh30_cat_perm"
    EXECUTE IMMEDIATE "DROP TABLE wh30_hdr"
    EXECUTE IMMEDIATE "DROP TABLE wh30_tag"
    EXECUTE IMMEDIATE "DROP TABLE wh30_tag_link"
...
FUNCTION db_add_constraints()
    ...
    EXECUTE IMMEDIATE "ALTER TABLE st02_cat ADD CONSTRAINT st02_cat_cat_code_key
        UNIQUE (cat_code)"
    EXECUTE IMMEDIATE "ALTER TABLE st30_tag_link ADD CONSTRAINT st30_tag_link_pkey
        PRIMARY KEY (id)"
    EXECUTE IMMEDIATE "ALTER TABLE st30_tag_link ADD CONSTRAINT st30_tag_link_stock_id_tag_id_key
    ...
    EXECUTE IMMEDIATE "ALTER TABLE st30_tag_link ADD CONSTRAINT st30_tag_link_stock_id_fkey
        ...
        ON DELETE CASCADE"
    EXECUTE IMMEDIATE "ALTER TABLE st30_tag_link ADD CONSTRAINT st30_tag_link_tag_id_fkey
        FOREIGN KEY (tag_id)
